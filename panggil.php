...
function penyebut($nilai) {
    ...
    if ($nilai < 12) {
        $temp =$huruf[$nilai];
         echo $say= "<audio controls autoplay src=\"audio/$temp.mp3\">/</audio>";
       // echo $say= "<audio src=\"audio/$temp.mp3\">/</audio>";
    } else if ($nilai <20) {
        $temp = $huruf[$nilai - 10];
        echo $say= "<audio autoplay controls src=\"audio/$temp.mp3\" >/</audio>";
        echo $say= "<audio autoplay controls src=\"audio/belas.mp3\" >/</audio>";
    } else if ($nilai < 100) {
        $temp =$huruf[$nilai/10];
        $temp2 = $huruf[$nilai%10];
        //$temp = penyebut($nilai/10)." puluh". penyebut($nilai % 10);
        echo $say= "<audio autoplay controls src=\"audio/$temp.mp3\" >/</audio>";
        echo $say= "<audio autoplay controls src=\"audio/puluh.mp3\" >/</audio>";
        echo $say= "<audio autoplay controls src=\"audio/$temp2.mp3\" >/</audio>";
    } else if ($nilai < 200) {
